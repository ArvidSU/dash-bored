...
export function createUiHarnessHost(): UiHarnessHost {
  ...
  return {
    ...
    async getUpdateState() { return { currentVersion: "0.2.6", settings: { channel: "stable" as const, automaticChecks: true }, release: null, receipt: null, dashboards: [], phase: "idle" as const, message: "UI fixture: no network check performed." }; },
