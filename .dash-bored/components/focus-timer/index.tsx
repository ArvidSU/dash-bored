...
export default defineComponent<{ title?: string; focusMinutes?: number; breakMinutes?: number }>(function FocusTimer({ props }) {
...
function Timer({ title, focusMinutes, breakMinutes }: { title: string; focusMinutes: number; breakMinutes: number }) {
